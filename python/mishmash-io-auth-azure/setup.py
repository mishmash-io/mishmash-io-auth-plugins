...
setup(
    name='mishmash_io_auth_azure',
    version='0.0.1',
    description='mishmash io auth azure plugin',
    ...
    project_urls={
        ...
        'Source Code': 'https://github.com/mishmash-io/mishmash-io-auth-plugins/tree/main/python/mishmash-io-auth-azure',
    },
